...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '1344621563:AAFpSLNaffD3w2x0vbP_PKQRnBdtnrOPhxI' # Get it from https://t.me/BotFather
    APP_ID = '1285124' # Get it from my.telegram.org/apps
    API_HASH = '83357d22cbd86ea82aba8d0e5bec9d61' # Get it from my.telegram.org/apps
